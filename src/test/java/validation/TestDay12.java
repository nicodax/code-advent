...
public class TestDay12 {
    ...
    public void readAndParse_nodes() {
        Day12 day12 = new Day12(PATH_TO_TEST_INPUT, true, 1);
    ...
    public void readAndParse_specialNodes() {
        ...
        assertEquals(new Node(0, 0, 'S'), startNode);
        assertEquals(new Node(5, 2, 'E'), endNode);
    }

    @Test
    @DisplayName("Should return the length of the shortest path from 'S' to 'E'")
    public void getShortestPathFromSToE() {
        Day12 day12 = new Day12(PATH_TO_TEST_INPUT, true, 1);
        assertEquals(31, day12.getPart1Solution());
    }

    @Test
    @DisplayName("Should return the length of the shortest path from any 'a' / 'S' to 'E'")
    public void getShortestPathFromAToE() {
        Day12 day12 = new Day12(PATH_TO_TEST_INPUT, true, 2);
        assertEquals(29, day12.getPart2Solution());
    }
}
