...
public class TestSolutions {
    ...
    /**
     * NOT A TEST -- ONLY PRINTS RESULTING IMAGE
     */
    @Test
    @Disabled
    @DisplayName("Should print the output image generated by carefully timing the CPU instructions and the CRT " +
            "drawing operations")
    ...
    public void day11Part1Solution() {
        ...
        Integer ROUNDS_TO_PROCESS_PART_1 = 20;
        Day11 day11 = new Day11(RELIEF_DIVIDER_PART_1);
        day11.readAndParseFile(PATH_TO_DAY_11_INPUT);
        assertEquals(64032, day11.getSolution(ROUNDS_TO_PROCESS_PART_1));
    }

    @Test
    @DisplayName("what is the level of monkey business after 10000 rounds?")
    public void day11Part2Solution() {
        Integer RELIEF_DIVIDER_PART_2 = 1;
        Integer ROUNDS_TO_PROCESS_PART_1 = 10000;
    ...
    public void day12Part1Solution() {
        Day12 day12 = new Day12(PATH_TO_DAY_12_INPUT, true);
        day12.resolve();
