...
public class Main {
    ...
    private static final Path PATH_TO_TEST_INPUT = Paths.get(System.getProperty("user.dir")
            + PATH_SEPARATOR + "src"
            + PATH_SEPARATOR + "main"
            + PATH_SEPARATOR + "resources"
            + PATH_SEPARATOR + "test-input-day12.txt");
    private static final Integer PART = 1;

    public static void main(String[] args) throws InterruptedException {
        Day12 day12 = new Day12(PATH_TO_INPUT, false, PART);
